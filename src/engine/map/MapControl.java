...
public class MapControl {
	...
	private ArrayList<DepthVector> depthVectors = new ArrayList<DepthVector>(); //ћассив с DepthVector хран€щий чанки
	public int numberWidth;// ол-во чанков
	public int numberHeight;
	public final int chunkSize = 100;
	public final int borderSize = 100;
	public int chunkRender = 0;// ол-во отрисованных чанков
	...
	public void update(Obj obj){
		for (int i=0; i<depthVectors.size(); i++){
			if (depthVectors.get(i).getDepth() == obj.depth){
